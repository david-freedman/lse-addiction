            ...
            <aside class="hidden lg:flex lg:flex-shrink-0">
                <div class="flex flex-col w-64 bg-white border-r border-gray-200">
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                        <a href="{{ route('home') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-teal-50 hover:text-teal-600 transition {{ request()->routeIs('home') ? 'bg-teal-50 text-teal-600 font-medium' : '' }}">
                        ...
                        @if(auth()->guard('web')->check() && auth()->guard('web')->user()->id === 1)
                            <a href="{{ route('admin.courses.index') }}" class="flex items-center px-4 py-3 text-blue-600 rounded-lg hover:bg-blue-50 transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center justify-between h-16 px-6">
                        <div class="flex items-center flex-1 gap-6">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <a href="#" class="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
