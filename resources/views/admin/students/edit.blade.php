    ...
    <form action="{{ route('admin.students.update', $student) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" name="specialty_1" id="specialty_1" value="{{ old('specialty_1', $student->specialty_1) }}"
            ...
            <div>
                ...
                <input type="text" name="specialty_2" id="specialty_2" value="{{ old('specialty_2', $student->specialty_2) }}"
