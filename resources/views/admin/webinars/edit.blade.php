...
@section('title', 'Редагувати вебінар')

@section('content')
<div class="mb-6">
    <h1 class="text-title-xl font-bold text-gray-900">Редагувати вебінар</h1>
</div>
            ...
            <div x-show="activeTab === 'main'" class="space-y-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        name="number"
                        id="number"
                        value="{{ old('number', $webinar->number) }}"
                        required
                        maxlength="7"
                        placeholder="1234567"
                ...
                <div x-data="{
                    open: false,
                    search: '',
                    selectedIds: {{ Js::from(old('teacher_ids', $webinar->teachers->pluck('id')->all())) }},
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('starts_at', $webinar->starts_at?->format('d.m.Y H:i')) }}"
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="old_price"
                            id="old_price"
                            value="{{ old('old_price', $webinar->old_price) }}"
                            step="0.01"
                            min="0"
                    ...
                    <div x-data="{ unlimited: {{ old('max_participants', $webinar->max_participants) === null ? 'true' : 'false' }} }">
                        ...
                        <div class="flex items-center gap-3">
                            <input
                                ...
                                id="max_participants"
                                value="{{ old('max_participants', $webinar->max_participants) }}"
                                min="1"
                                :disabled="unlimited"
                ...
                <div>
                    ...
                    @if($webinar->banner)
                        <div class="mb-3 overflow-hidden rounded-lg">
                            <img src="{{ $webinar->banner_url }}" alt="Current banner" class="max-w-md rounded-lg border border-gray-200">
                        </div>
                    @endif
                    <input
                        type="file"
                ...
                <div>
                    ...
                    >
                        @foreach($statuses as $status)
                            <option value="{{ $status->value }}" {{ old('status', $webinar->status->value) === $status->value ? 'selected' : '' }}>
                                {{ $status->label() }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <input
                            ...
                            id="sync_to_wp"
                            value="1"
                            {{ old('sync_to_wp', $webinar->sync_to_wp) ? 'checked' : '' }}
            ...
            <div x-show="activeTab === 'certificate'" class="space-y-5">
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('cert_company_name', $webinar->cert_company_name ?? 'Медична академія') }}"
                ...
                <div>
                    ...
                    <input
                        ...
                        name="cert_bpr_hours"
                        id="cert_bpr_hours"
                        value="{{ old('cert_bpr_hours', $webinar->cert_bpr_hours) }}"
                        min="1"
                ...
                <div>
                    ...
                    <input
                        ...
                        id="cert_specialties"
                        value="{{ old('cert_specialties', $webinar->cert_specialties) }}"
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="student" {{ old('cert_participant_type', $webinar->cert_participant_type) === 'student' ? 'selected' : '' }}>Студент</option>
                        <option value="trainer" {{ old('cert_participant_type', $webinar->cert_participant_type) === 'trainer' ? 'selected' : '' }}>Тренер</option>
                    </select>
                ...
                <div>
                    ...
                    @if($webinar->cert_signature)
                        <div class="mb-3">
                            <img src="{{ \Storage::disk('public')->url($webinar->cert_signature) }}" alt="Поточний підпис" class="max-h-24 rounded-lg border border-gray-200 bg-gray-50 p-2">
                        </div>
                    @endif
                    <input
                        type="file"
                    ...
                    >
                    <p class="mt-1 text-xs text-gray-500">PNG або JPG, до 10 МБ. Залиште порожнім, щоб зберегти поточний.</p>
                ...
                <div>
                    ...
                    @if($webinar->cert_stamp)
                        <div class="mb-3">
                            <img src="{{ \Storage::disk('public')->url($webinar->cert_stamp) }}" alt="Поточна печатка" class="max-h-24 rounded-lg border border-gray-200 bg-gray-50 p-2">
                        </div>
                    @endif
                    <input
                        type="file"
