...
<div class="mb-6 flex items-center justify-between">
    <h1 class="text-title-xl font-bold text-gray-900">Створити групу</h1>
...
<div class="rounded-2xl border border-gray-200 bg-white p-6">
    <form action="{{ route('admin.student-groups.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="flex gap-3 pt-4">
            ...
            <a href="{{ route('admin.student-groups.index') }}" class="rounded-lg border border-gray-300 bg-white px-6 py-3 font-medium text-gray-700 transition hover:bg-gray-50">
                Скасувати
            </a>
        </div>
    </form>
