...
@section('content')
<div class="mb-6">
    <a href="{{ route('admin.webinar-quiz.questions.index', $webinar) }}" class="text-sm text-gray-500 hover:text-gray-700">
        ← Назад до питань
    </a>
    <h1 class="text-title-xl font-bold text-gray-900 mt-1">Редагувати питання</h1>
    <p class="text-gray-500">{{ $webinar->title }}</p>
</div>

<div class="rounded-2xl border border-gray-200 bg-white p-6">
    <form action="{{ route('admin.webinar-quiz.questions.update', [$webinar, $question]) }}"
          method="POST"
        ...
        <div class="flex gap-3 mt-6">
            ...
            <a href="{{ route('admin.webinar-quiz.questions.index', $webinar) }}" class="rounded-lg border border-gray-300 px-5 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50">
                Скасувати
            </a>
        </div>
    </form>
