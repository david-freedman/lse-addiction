...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex space-x-2 mb-6 border-b border-gray-200">
            <a href="{{ route('customer.my-courses') }}"
            ...
            <a href="{{ route('customer.my-courses', ['status' => 'active']) }}"
            ...
            <a href="{{ route('customer.my-courses', ['status' => 'completed']) }}"
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition group">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex items-center text-sm text-gray-600 mb-4">
                                ...
                                Викладач: {{ $course->coach->name ?? 'Не вказано' }}
                            </div>
                            ...
                            <a href="{{ route('customer.courses.show', $course) }}"
