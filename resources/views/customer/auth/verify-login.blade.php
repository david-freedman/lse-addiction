...
<div class="main-page__auth auth">
    <div class="auth__main">
        ...
        <div class="auth__body">
            ...
            <form action="{{ route('customer.verify-login') }}" method="POST" class="auth__content" id="verifyForm">
                @csrf
            ...
            <form action="{{ route('customer.verify-login.resend') }}" method="POST" style="text-align: center; margin-top: 15px;">
                @csrf
            ...
            <div class="auth__label" style="text-align: center; margin-top: 15px;">
                <a href="{{ route('customer.login') }}">← Повернутися до входу</a>
            </div>
        </div>
    </div>
