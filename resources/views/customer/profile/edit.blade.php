...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="relative group">
                            @if($customer->hasProfilePhoto())
                                <img id="profile-photo-preview" src="{{ $customer->profile_photo_url }}" alt="Profile Photo" class="w-24 h-24 rounded-full object-cover">
                            @else
                                <div id="profile-photo-preview" class="w-24 h-24 rounded-full bg-teal-500 flex items-center justify-center">
                                    <span class="text-white text-2xl font-semibold">{{ $customer->initials }}</span>
                                </div>
                            @endif
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $customer->name) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                            @error('name')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="surname" id="surname" value="{{ old('surname', $customer->surname) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                            @error('surname')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email', $customer->email) }}" placeholder="{{ $customer->email }}" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" id="phone" value="{{ old('phone', $customer->phone) }}" placeholder="+380XXXXXXXXX" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="date" name="birthday" id="birthday" value="{{ old('birthday', $customer->birthday?->format('Y-m-d')) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="text" name="city" id="city" value="{{ old('city', $customer->city) }}" placeholder="Введіть своє місто" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                            @error('city')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
        ...
        <div id="profile-fields-tab" class="tab-content hidden">
            <form action="{{ route('customer.profile.profile-fields.update') }}" method="POST" class="p-8">
                @csrf
                @method('PATCH')
