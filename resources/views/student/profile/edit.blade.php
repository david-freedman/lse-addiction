            ...
            <form action="{{ route('student.profile.update') }}" method="POST" enctype="multipart/form-data" class="p-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="patronymic" class="block text-sm font-medium text-gray-700 mb-2">По-батькові</label>
                            <input type="text" name="patronymic" id="patronymic" value="{{ old('patronymic', $student->patronymic) }}" placeholder="Введіть своє по-батькові" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                            @error('patronymic')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
