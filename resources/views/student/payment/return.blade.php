    ...
    <div class="bg-white rounded-xl shadow-md p-8">
        @if($status === 'success')
            <div class="text-center">
                ...
                <div class="space-y-3">
                    <a href="{{ route('student.my-courses') }}" class="block w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-3 px-6 rounded-lg transition">
                        Перейти до моїх курсів
                    </a>
                    <a href="{{ route('student.transactions.index') }}" class="block w-full border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium py-3 px-6 rounded-lg transition">
