...
<div class="max-w-md mx-auto">
    <div class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8">
        ...
        <form action="{{ route('student.complete-verification.verify') }}" method="POST">
            @csrf
        ...
        <form action="{{ route('student.complete-verification.resend') }}" method="POST" class="mt-2 text-center">
            @csrf
            <button
                id="resend-button"
                type="submit"
