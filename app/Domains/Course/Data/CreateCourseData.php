...
class CreateCourseData extends Data
{
    ...
    public static function rules(): array
    {
        return [
            ...
            'registration_starts_at' => array_filter(['nullable', 'date', 'date_format:d.m.Y H:i', 'required_with:registration_ends_at', request('starts_at') ? 'before_or_equal:starts_at' : null]),
