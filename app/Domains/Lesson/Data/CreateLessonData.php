...
class CreateLessonData extends Data
{
    public function __construct(
        ...
        public readonly ?int $quiz_passing_score = 70,
        ...
        public readonly bool $allow_retake_after_pass = true,

        public readonly bool $has_homework = false,
        ...
        public readonly ?int $homework_max_points = 10,
        ...
        public readonly bool $homework_is_required = false,

        #[Nullable]
        public readonly ?array $homework_allowed_extensions = null,

        #[Nullable, Min(1), Max(50)]
        public readonly ?int $homework_max_file_size_mb = 10,

        #[Nullable, Min(1), Max(20)]
        public readonly ?int $homework_max_files = 5,
    ) {}
